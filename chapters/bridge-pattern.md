...
UML class diagram (left) of modern variation of Bridge pattern.
*[Image will be replaced]* [[Image source](https://en.wikipedia.org/wiki/File:W3sDesign_Bridge_Design_Pattern_UML.jpg)]
```
